...
var Login = mongoose.model('Login',LoginSchema,'loginusers')

var userName="admin"
var email="kwan4418@uni.sydney.edu.au"
	
Login.find({$or:[{"userName":userName},{"email":email}]})
//Login.find({})
